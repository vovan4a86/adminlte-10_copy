...
!(function (e, t) {
  ...
  function i(e, t) {
    ...
    function ne(e) {
      if (ae.length) {
        for (var t = !1, n = (e = 'string' == typeof e ? [e] : e).length, a = 0; a < n; a++)
    ...
    function n(e) {
      if (e.querySelector('ul') || 'UL' === e.tagName) {
        ...
        te.customToggle
          ...
          : ((f = [ee.createElement('a', { href: '#' }, ee.createElement('span'))]),
        ...
        var w = function (e, t, n) {
            ...
            'number' != typeof t ||
              ...
              ((a = Array.prototype.filter.call(d.querySelectorAll('.nav-wrapper'), function (e) {
                return (
                  ...
                  ('number' != typeof n || ('number' == typeof n && e.getAttribute('data-index') == n))
                );
              })[0]),
              ...
              (a = Array.prototype.filter.call(a, function (e) {
                ...
                ie.addEventListener(o, function (e) {
                  ('Tab' !== e.key && 9 !== e.keyCode) ||
                    (e.shiftKey
                      ? ie.activeElement === i && (e.preventDefault(), s.focus())
                      : ie.activeElement === s && (e.preventDefault(), i.focus()));
                })));
          },
          S = function () {
            ie.removeEventListener(o),
          ...
          M = function () {
            ...
            s.add(
              ...
              s.add(
                '.hc-offcanvas-nav.' + b + '.nav-position-bottom .nav-container',
                'transform: translate3d(0, ' + t + ', 0)'
              ),
              s.insert(),
              (u.style.display = ''),
          ...
          j = function (e) {
            ...
            (!ee.isNumeric(a) && -1 === a.indexOf('px')) || (A = parseInt(a)),
              ...
              s.add(
                '.hc-offcanvas-nav.' + b + '.nav-levels-overlap.nav-position-left li.level-open > .nav-wrapper',
                'transform: translate3d(-' + i + ', 0, 0)',
                n
              ),
              s.add(
                '.hc-offcanvas-nav.' + b + '.nav-levels-overlap.nav-position-right li.level-open > .nav-wrapper',
                'transform: translate3d(' + i + ', 0, 0)',
                n
              ),
              s.add(
                '.hc-offcanvas-nav.' + b + '.nav-levels-overlap.nav-position-top li.level-open > .nav-wrapper',
                'transform: translate3d(0, -' + i + ', 0)',
                n
              ),
              s.add(
                '.hc-offcanvas-nav.' + b + '.nav-levels-overlap.nav-position-bottom li.level-open > .nav-wrapper',
                'transform: translate3d(0, ' + i + ', 0)',
                n
              ),
              s.insert(),
            ...
            !(function p(n, e, f, h, t, a) {
              ...
              h &&
                ...
                ((e =
                  'string' == typeof h
                    ? h
                    : ee.clone(re.jQuery && h instanceof re.jQuery && h.length ? h[0] : h, !0, !0)),
                r.insertBefore(
                  ee.createElement(
                    'div',
                    { id: 0 === f ? b + '-nav-title' : null, class: 0 === f ? 'nav-title' : 'level-title' },
                    e
                  ),
                  r.firstChild
                ),
                  ...
                  ? (i++,
                    ...
                    e.items.forEach(function (t, e) {
                      ...
                      if (t.custom) {
                        ...
                        return (
                          te.keepClasses && t.htmlClass && a.classList.add.apply(a.classList, t.htmlClass.split(' ')),
                        ...
                        te.closeOnClick &&
                          (W()
                            ? 'A' !== r.tagName ||
                              ...
                              (t.subnav.length &&
                                (!r.getAttribute('href') || '#' === r.getAttribute('href').charAt(0))) ||
                          ...
                          W()
                            ? ((c = O[s]),
                              ...
                              (a = function (e) {
                                e.addEventListener('click', function (e) {
                                  e.stopPropagation(),
                                    ...
                                    'createEvent' in ie &&
                                      ((e = ie.createEvent('HTMLEvents')).initEvent('change', !1, !0),
                                      v.dispatchEvent(e));
                                }),
                                  e.addEventListener('keydown', function (e) {
                              ...
                              r.getAttribute('href') && '#' !== r.getAttribute('href')
                                ...
                                : (r.appendChild(
                                    ee.createElement('span', { class: 'nav-next' }, ee.createElement('span'))
                                  ),
                                  a(r)))
              ...
              f &&
                ...
                (l = ee.createElement('a', { href: '#', class: 'nav-back-button', role: 'menuitem', tabindex: 0 }, [
                  a,
                  ee.createElement('span')
                ])),
                !0 === te.insertBack || 0 === te.insertBack
                  ...
                  : ((o = ee.createElement('li', { class: 'nav-item nav-back' }, l)),
                    ee.insertAt(o, !0 === te.insertBack ? 0 : te.insertBack, s)),
                (o = function () {
                  return Z(f, t);
                }),
          ...
          D = function (e) {
            ...
            (('left' === te.position && r < 50) || ('right' === te.position && r > ie.body.clientWidth - 50)) &&
          ...
          U = function e(t) {
            ...
            ie.removeEventListener('touchmove', D),
              ...
              l &&
                ...
                (n = A + n),
                (t = 'left' === te.position ? Math.min(Math.max(t, 0), n) : Math.abs(Math.min(Math.max(t, -n), 0)))
                  ? H(70 < t ? 'open' : 'close')
                  : H('close', !1),
                (i = r = null),
                (l = !1));
          ...
          z = function (e) {
            ...
            Math.abs(t) < Math.abs(n) ||
              ...
              (('left' === te.position && t < 0) || ('right' === te.position && 0 < t)) &&
          ...
          i &&
            ...
            n &&
              ...
              m &&
                ...
                ee.setTransform(m, t + (e - 1) * te.levelSpacing, te.position))));
        };
        return (
          (u.on = function (e, t) {
        ...
        !1 === e && (o.style.transition = 'none'),
          ...
          u._eventListeners['open.level'] &&
            u._eventListeners['open.level'].forEach(function (e) {
              e.fn(
                ee.customEventObject('open.level', u, o, { currentLevel: t, currentIndex: n }),
                Object.assign({}, te)
              );
            }),
          N && (w(0, t, n), (N = !1));
      ...
      function Z(t, e) {
        ...
        0 < t &&
          ...
          u._eventListeners['close.level'].forEach(function (e) {
            e.fn(
              ee.customEventObject('close.level', u, n, { currentLevel: t - 1, currentIndex: G() }),
              Object.assign({}, te)
            );
          })),
          N && (w(null, t - 1), (N = !1));
