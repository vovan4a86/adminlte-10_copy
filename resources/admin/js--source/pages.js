...
import {pageContent, popup, popupClose, sendAjax} from "./interface";

import 'summernote';
import 'jquery-contextmenu'; //https://swisnl.github.io/jQuery-contextMenu/
    ...
    switch (action) {
        ...
        case "paste":
            ...
            if (pasteMode === "cut") {
                ...
                let cb = clipboardNode.toDict(true);
                ...
                let cb = clipboardNode.toDict(true, function (dict, node) {
...
const tree = createTree('#pages-tree', {
    ...
    extensions: ['edit', 'filter', 'dnd5', 'persist'],
            ...
            callback: function(key, opt){
                ...
                if (confirm("Действительно удалить страницу?")) {
                    ...
                    sendAjax(url, {}, function (json) {
                        if (json.success) {
                            node.remove();
                            toastr.success('Страница удалена!');
                        } else {
